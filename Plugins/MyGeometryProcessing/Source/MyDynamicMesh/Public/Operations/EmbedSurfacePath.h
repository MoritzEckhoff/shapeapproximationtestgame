...
struct MYDYNAMICMESH_API FMeshSurfacePoint
{
	int ElementID;
	FVector3d BaryCoord;
 ...
 */
//bool MYDYNAMICMESH_API WalkMeshPlanar(
 ...
 */
class MYDYNAMICMESH_API FMeshSurfacePath
{
public:
	FDynamicMesh3 *Mesh;
 ...
 */
bool MYDYNAMICMESH_API EmbedProjectedPath(FDynamicMesh3* Mesh, int StartTriID, FFrame3d Frame, const TArray<FVector2d>& Path2D, TArray<int>& OutPathVertices, TArray<int>& OutVertexCorrespondence, bool bClosePath, FMeshFaceSelection *EnclosedFaces = nullptr, double PtSnapVertexOrEdgeThresholdSq = FMathf::ZeroTolerance*100);
