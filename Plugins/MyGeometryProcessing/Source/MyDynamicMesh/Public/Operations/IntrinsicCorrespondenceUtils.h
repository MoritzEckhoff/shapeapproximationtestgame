...
namespace IntrinsicCorrespondenceUtils
{
	...
	struct MYDYNAMICMESH_API FSurfacePoint
	{
	...
	*/
	...
	struct MYDYNAMICMESH_API FMeshConnection
	{
	...
	*/
	struct MYDYNAMICMESH_API FNormalCoordinates : public FMeshConnection
	{
	...
	* is initialized with the same connectivity as the surface mesh.  Note, it is assumed that the surface mesh has no bow-ties.
	*/
	struct MYDYNAMICMESH_API FSignpost : public FMeshConnection
	{
		typedef FMeshConnection  MyBase;
