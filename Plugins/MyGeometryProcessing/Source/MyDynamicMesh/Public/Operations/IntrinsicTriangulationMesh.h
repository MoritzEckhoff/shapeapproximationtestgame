...
*/
class MYDYNAMICMESH_API FSimpleIntrinsicEdgeFlipMesh
{
public:
...
*/
class MYDYNAMICMESH_API FIntrinsicEdgeFlipMesh : public  FSimpleIntrinsicEdgeFlipMesh
{
public:
	...
	*/ 
	struct MYDYNAMICMESH_API FEdgeCorrespondence
	{
...
*/ 
class MYDYNAMICMESH_API FIntrinsicTriangulation : public FSimpleIntrinsicEdgeFlipMesh
{
...
*/
int32 MYDYNAMICMESH_API FlipToDelaunay(FSimpleIntrinsicEdgeFlipMesh& IntrinsicMesh, TSet<int>& Uncorrected, const int32 MaxFlipCount = TMathUtilConstants<int>::MaxReal);
int32 MYDYNAMICMESH_API FlipToDelaunay(FIntrinsicEdgeFlipMesh& IntrinsicMesh, TSet<int>& Uncorrected, const int32 MaxFlipCount = TMathUtilConstants<int>::MaxReal);
int32 MYDYNAMICMESH_API FlipToDelaunay(FIntrinsicTriangulation& IntrinsicMesh, TSet<int>& Uncorrected, const int32 MaxFlipCount = TMathUtilConstants<int>::MaxReal);
