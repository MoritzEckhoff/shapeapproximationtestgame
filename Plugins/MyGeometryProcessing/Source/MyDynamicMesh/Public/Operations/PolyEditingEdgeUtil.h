 ...
 */
MYDYNAMICMESH_API void ComputeInsetLineSegmentsFromEdges(
 ...
 */
MYDYNAMICMESH_API void SolveInsetVertexPositionsFromInsetLines(
	const FDynamicMesh3& Mesh,
 ...
 */
MYDYNAMICMESH_API FVector3d SolveInsetVertexPositionFromLinePair(
