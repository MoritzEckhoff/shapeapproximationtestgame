 ...
 */
class MYDYNAMICMESH_API FMeshGenericWorldPositionColorBaker : public FMeshImageBaker
{
public:
 ...
 */
class MYDYNAMICMESH_API FMeshGenericWorldPositionNormalBaker : public FMeshImageBaker
{
public:
