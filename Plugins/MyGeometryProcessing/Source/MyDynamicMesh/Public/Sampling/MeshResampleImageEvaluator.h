 ...
 */
class MYDYNAMICMESH_API FMeshResampleImageEvaluator : public FMeshMapEvaluator
{
public:
 ...
 */
class MYDYNAMICMESH_API FMeshMultiResampleImageEvaluator : public FMeshResampleImageEvaluator
{
public:
