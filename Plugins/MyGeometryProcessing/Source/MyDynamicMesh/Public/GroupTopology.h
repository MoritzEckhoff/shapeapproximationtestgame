 ...
 */
struct MYDYNAMICMESH_API FGroupTopologySelection
{
 ...
 */
class MYDYNAMICMESH_API FGroupTopology
{
public:
	FGroupTopology() {}
	 ...
	 */
	struct MYDYNAMICMESH_API FCorner
	{
		/** Mesh Vertex ID */
		int VertexID;		
	...
	struct MYDYNAMICMESH_API FGroupBoundary
	{
	...
	struct MYDYNAMICMESH_API FGroup
	{
	 ...
	 */
	struct MYDYNAMICMESH_API FGroupEdge
	{
 ...
 */
class MYDYNAMICMESH_API FTriangleGroupTopology : public FGroupTopology
{
public:
