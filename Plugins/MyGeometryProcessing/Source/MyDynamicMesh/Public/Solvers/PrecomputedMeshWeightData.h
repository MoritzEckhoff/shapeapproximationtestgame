...
namespace UE
{
	namespace MeshDeformation
	{
		...
		MYDYNAMICMESH_API int32 ComputeNumMatrixElements(const MeshT& DynamicMesh, const TArray<int32>& ToVtxId)
		{
		...
		*
		*/
		class MYDYNAMICMESH_API CotanTriangleData
		{
		public:
		...
		*
		*/
		class MYDYNAMICMESH_API MeanValueTriangleData
		{
