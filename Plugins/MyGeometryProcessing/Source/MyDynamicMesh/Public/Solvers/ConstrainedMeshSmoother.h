...
namespace UE
{
	namespace MeshDeformation
	{
		...
		*
		*/
		TUniquePtr<UE::Solvers::IConstrainedMeshSolver> MYDYNAMICMESH_API ConstructConstrainedMeshSmoother(const ELaplacianWeightScheme WeightScheme, const FDynamicMesh3& DynamicMesh);
	}
}
