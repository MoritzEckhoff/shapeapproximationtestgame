...
namespace UE
{
	namespace MeshDeformation
	{
		...
		*   // Update Mesh?
		*/
		TUniquePtr<UE::Solvers::IConstrainedMeshSolver> MYDYNAMICMESH_API ConstructConstrainedMeshDeformer(const ELaplacianWeightScheme WeightScheme, const FDynamicMesh3& DynamicMesh);
		 ...
		 * 
		 */
		TUniquePtr<UE::Solvers::IConstrainedMeshSolver> MYDYNAMICMESH_API ConstructUniformConstrainedMeshDeformer(const FDynamicGraph3d& Graph);
		 ...
		 *
		 */
		TUniquePtr<UE::Solvers::IConstrainedLaplacianMeshSolver> MYDYNAMICMESH_API ConstructSoftMeshDeformer(const FDynamicMesh3& DynamicMesh);
