...
*/
FString MYDYNAMICMESH_API LaplacianSchemeName(const ELaplacianWeightScheme Scheme);


/**
* @return true if Laplacian scheme produces a symmetric matrix
*/
bool MYDYNAMICMESH_API bIsSymmetricLaplacian(const ELaplacianWeightScheme Scheme);
