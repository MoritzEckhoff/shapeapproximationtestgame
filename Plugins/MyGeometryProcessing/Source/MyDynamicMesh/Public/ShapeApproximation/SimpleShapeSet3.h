 ...
 */
class MYDYNAMICMESH_API FSphereShape3d
{
public:
	FSphere3d Sphere;
 ...
 */
struct MYDYNAMICMESH_API FBoxShape3d
{
	FOrientedBox3d Box;
 ...
 */
struct MYDYNAMICMESH_API FCapsuleShape3d
{
	FCapsule3d Capsule;
 ...
 */
struct MYDYNAMICMESH_API FConvexShape3d
{
	FDynamicMesh3 Mesh;
 ...
 */
struct MYDYNAMICMESH_API FSimpleShapeSet3d
{
