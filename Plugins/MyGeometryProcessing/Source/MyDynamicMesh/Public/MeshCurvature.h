...
namespace UE
{
	...
	namespace MeshCurvature
	{
		 ...
		 */
		MYDYNAMICMESH_API FVector3d MeanCurvatureNormal(const FDynamicMesh3& Mesh, int32 VertexIndex);
		 ...
		 */
		MYDYNAMICMESH_API FVector3d MeanCurvatureNormal(const FDynamicMesh3& Mesh, int32 VertexIndex, TFunctionRef<FVector3d(int32)> VertexPositionFunc);
		 ...
		 */
		MYDYNAMICMESH_API double GaussianCurvature(const FDynamicMesh3& Mesh, int32 VertexIndex);
		 ...
		 * @param VertexPositionFunc use positions returned by this function instead of mesh positions
		 */
		MYDYNAMICMESH_API double GaussianCurvature(const FDynamicMesh3& Mesh, int32 VertexIndex, TFunctionRef<FVector3d(int32)> VertexPositionFunc);
 ...
 */
class MYDYNAMICMESH_API FMeshVertexCurvatureCache
{
public:
