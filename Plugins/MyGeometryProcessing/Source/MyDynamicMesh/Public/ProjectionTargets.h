 ...
 */
class MYDYNAMICMESH_API FMeshProjectionTarget : public IOrientedProjectionTarget
{
public:
...
class MYDYNAMICMESH_API FWorldSpaceProjectionTarget : public FMeshProjectionTarget
{
public:
