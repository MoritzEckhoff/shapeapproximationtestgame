...
namespace UVUnwrapMeshUtil {
	 ...
	 */
	MYDYNAMICMESH_API void GenerateUVUnwrapMesh(const FDynamicMeshUVOverlay& UVOverlay, FDynamicMesh3& UnwrapMeshOut,
	 ...
	 */
	MYDYNAMICMESH_API void UpdateUVUnwrapMesh(const FDynamicMeshUVOverlay& UVOverlayIn,
	 ...
	 * @param ChangedConnectivityTids If not null, only update triangle connectivity corresponding to the given triangle IDs.
	 */
	MYDYNAMICMESH_API void UpdateUVUnwrapMesh(const FDynamicMesh3& SourceUnwrapMesh, FDynamicMesh3& DestUnwrapMesh,
	 ...
	 * @param ChangedConnectivityTids If not null, only update triangle connectivity corresponding to the given triangle IDs.
	 */
	MYDYNAMICMESH_API void UpdateUVOverlayFromUnwrapMesh(
	 ...
	 * @param ChangedConnectivityTids If not null, only update triangle connectivity corresponding to the given triangle IDs.
	 */
	MYDYNAMICMESH_API void UpdateOverlayFromOverlay(const FDynamicMeshUVOverlay& OverlayIn, FDynamicMeshUVOverlay& OverlayOut,
	...
	MYDYNAMICMESH_API bool DoesUnwrapMatchOverlay(const FDynamicMeshUVOverlay& OverlayIn, const FDynamicMesh3& UnwrapMeshIn,
