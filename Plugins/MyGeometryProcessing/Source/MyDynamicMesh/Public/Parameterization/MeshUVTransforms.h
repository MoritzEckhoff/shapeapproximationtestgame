...
namespace UE
{
	namespace MeshUVTransforms
	{
		 ...
		 */
		MYDYNAMICMESH_API void RecenterScale(FDynamicMeshUVOverlay* UVOverlay, const TArray<int32>& UVElementIDs,
		 ...
		 */
		MYDYNAMICMESH_API void FitToBox(FDynamicMeshUVOverlay* UVOverlay, const TArray<int32>& UVElementIDs, const FAxisAlignedBox2d& Box, bool bUniformScale = true);

		/**
		 * Fit all UV element IDs of the UV Overlay inside the specified Box.
		 * @param bUniformScale if false, UVs will be non-uniformly scaled to maximally fill the box
		 */
		MYDYNAMICMESH_API void FitToBox(FDynamicMeshUVOverlay* UVOverlay, const FAxisAlignedBox2d& Box, bool bUniformScale = true);
		 ...
		 */
		MYDYNAMICMESH_API void MakeSeamsDisjoint(FDynamicMeshUVOverlay* UVOverlay);
	}
}