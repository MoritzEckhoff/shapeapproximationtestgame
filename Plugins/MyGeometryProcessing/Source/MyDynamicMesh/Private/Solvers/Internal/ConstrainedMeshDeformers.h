 ...
 */
class MYDYNAMICMESH_API FConstrainedMeshDeformer : public FConstrainedMeshDeformationSolver
{
public:
 ...
 */
class MYDYNAMICMESH_API FSoftMeshDeformer : public FSoftMeshDeformationSolver
{
public:
