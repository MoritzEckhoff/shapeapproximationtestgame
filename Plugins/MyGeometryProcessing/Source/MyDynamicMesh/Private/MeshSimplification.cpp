...
template<>
void MYDYNAMICMESH_API TMeshSimplification<FAttrBasedQuadricErrord>::OnEdgeCollapse(int edgeID, int va, int vb, const FDynamicMesh3::FEdgeCollapseInfo& collapseInfo)
{
...
template class MYDYNAMICMESH_API TMeshSimplification< FAttrBasedQuadricErrord >;
template class MYDYNAMICMESH_API TMeshSimplification< FVolPresQuadricErrord >;
template class MYDYNAMICMESH_API TMeshSimplification< FQuadricErrord >;
