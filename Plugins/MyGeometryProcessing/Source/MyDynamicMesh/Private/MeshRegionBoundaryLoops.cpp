...
template MYDYNAMICMESH_API bool FMeshRegionBoundaryLoops::GetLoopOverlayMap<float, 2, FVector2f>(
	const FEdgeLoop& LoopIn, const TDynamicMeshOverlay<float, 2>& Overlay,
	VidOverlayMap<FVector2f>& LoopVidsToOverlayElementsOut);
template MYDYNAMICMESH_API void FMeshRegionBoundaryLoops::UpdateLoopOverlayMapValidity<float, 2, FVector2f>(
